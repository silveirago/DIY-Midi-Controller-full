...
const byte BUTTON_ARDUINO_PIN[N_BUTTONS] = {5, 18, 19}; //* pins of each button connected straight to the Arduino
...
const byte POT_ARDUINO_PIN[N_POTS_ARDUINO] = {4, 2}; //* pins of each pot connected straight to the Arduino (don't use "A" if you are using ESP32, only the number)
...
const byte varThreshold = 30; //* Threshold for the potentiometer signal variation - Increase if using ESP32
